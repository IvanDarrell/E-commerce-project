...
public class Common {
	...
	public void navigate() throws IOException {
		...
		try {
			...
			log.getScenario().fail("Redirection to the site is unsuccessful",MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
	...
	public void customerlogin() throws IOException {
		...
		try {
			...
			log.getScenario().pass("Customer logged in successfully");

		} catch (Exception e) {

			log.getScenario().fail("Customer unsuccessful login",MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
			log.onTestFailure("Fail");
	...
	public void userverifyshopmodule() throws IOException {
		...
		try {
			...
			log.getScenario().pass("Modules are visible");
		} catch (Exception e) {
	...
	public void userselectshopmodule(String module) throws IOException {
		...
		try {
			...
			if (clicked) {
				log.getScenario().pass("Successfully selected a shop option");
			}

		} catch (Exception e) {

			log.getScenario().fail("Cannot select shop option",MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
			log.onTestFailure("Fail");
	...
	public void verifyconfirmdetails() throws IOException {
		...
		try {
			...
			if (verifyfname) {
				log.getScenario().pass("First name is correct" );
			}
			...
			if (verifymname) {
				log.getScenario().pass("Middle name is correct");
			}
			...
			if (verifylname) {
				log.getScenario().pass("Last name is correct");
			}
			...
			if (verifyemail) {
				log.getScenario().pass("Email is correct");
			}
			...
			if (verifyphone) {
				log.getScenario().pass("Mobile number is correct");
			}
			...
			if (verifyaddress) {
				log.getScenario().pass("Address is correct");
			}
			...
			if (verifystate) {
				log.getScenario().pass("State is correct");
			}
			...
			if (verifycity) {
				log.getScenario().pass("City is correct");
			}
			...
			log.getScenario().fail("Cannot verify the Confirm Details",MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
			log.onTestFailure("Fail");
	...
	public void goback() throws IOException {
		...
		try {
			...
			if (click) {
				log.getScenario().pass("Successfully went back to previous page");
			}
		} catch (Exception e) {

			log.getScenario().fail("Previous page cannot be done",MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
			log.onTestFailure("Fail");
	...
	public void searchproduct(String product, SoftAssert softAssert) throws IOException {
		...
		try {
			...
			if (search) {
				log.getScenario().pass("Successfully searched product");
			}
		} catch (Exception e) {

			log.getScenario().fail("Searching product failed",MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
			log.onTestFailure("Fail");
	...
	public void sortby(String option, SoftAssert softAssert) throws IOException {
		...
		try {
			...
			if (selectdrop) {
				log.getScenario().pass("Successfully sorted product");
			}
	...
	public void filter(String filtername, SoftAssert softAssert) throws IOException {
		...
		try {
			...
			if (filterclick) {
				log.getScenario().pass("Successfully filter it by " + filtername);
			}

		} catch (Exception e) {

			log.getScenario().fail("Failed in filterting the product",MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
			log.onTestFailure("Fail");
	...
	public void addtocart(String itemname, SoftAssert softAssert) throws IOException {
		...
		try {
			...
			*/
			...
			if (clicked) {
				log.getScenario().pass("Successfully Added the Item" + itemname);
			}

		} catch (Exception e) {

			log.getScenario().fail("Adding product failed",MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
			log.onTestFailure("Fail");
	...
	public void verifyfilters(String filters) throws IOException {
		...
		try {
			...
			if (!expectedValues.equals(currentValues)) {
				...
				log.getScenario().fail("Expected: " + expectedValues + " | Current: " + currentValues);

				fail("Filter options don't match. Expected: " + expectedValues + " but found: " + currentValues);
			}

			log.getScenario().pass("Filter options verified successfully: " + currentValues);

		} catch (Exception e) {

			e.printStackTrace();

			log.getScenario().fail("Verification failed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
		...
		try {
			...
			for (String items : orders.keySet()) {
				...
				if (itemelement.isDisplayed()) {
					...
					log.getScenario().pass("Item : " + items + " is shown ");

				} else {

					log.getScenario().fail("Item : " + items + " is not shown ",MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
			...
			log.getScenario().fail("Verification failed: " + e.getMessage());
			...
			for (String items : orders.keySet()) {
				...
				if (itemquantity == orders.get(items)) {
					...
					log.getScenario().fail(
							"Expected item quantity : " + orders.get(items) + " is not displayed" + " Item " + items,MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
				...
				if (totalpriceincart.equals(orderprice.get(items))) {
					...
					*/
					log.getScenario().pass("Expected Total Price : " + orderprice.get(items) + " is displayed");

				} else {
					softAssert.assertTrue(totalpriceincart == (Integer) orders.get(items), "Values are not the the same");
					log.getScenario().fail("Expected Total Price : " + orderprice.get(items) + " is not displayed, Actual " + totalpriceincart,MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
	...
	public void verifytotalcart() throws IOException {
		...
		try {
			...
			if (overallcart.equals(totalcart)) {
				...
				log.getScenario().pass(
						"Expected Total Price : " + overallcart + " and Current Value " + totalcart + " is correct");

			} else {

				log.getScenario().fail(
						"Expected Total Price : " + overallcart + " and Current Value " + totalcart + " is INCORRECT",MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
	...
	public void populatebillingaddress() throws IOException {
		...
		try {
			...
			log.getScenario().pass("Billing Address populated");

		} catch (Exception e) {

			e.printStackTrace();
			log.getScenario().fail("Population of fields: " + e.getMessage());
			log.onTestFailure("Fail");
			Assert.fail("Test failed due to exception: " + e.getMessage());
		}
	...
	public void deleteitemfromcart(String item, SoftAssert softAssert) throws IOException {
		...
		try {
			...
			log.getScenario().pass("Deleted Product success! Current overall cart " + overallcart);

		} catch (Exception e) {

			e.printStackTrace();
			log.getScenario().fail("Deleted Product success failed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
			log.onTestFailure("Fail");
	...
	public void addquantitytoitem(String item, Integer count, SoftAssert softAssert) throws IOException {
		...
		try {
			...
			*/
			...
			log.getScenario().pass("Added quantity Price");

		} catch (Exception e) {

			e.printStackTrace();
			log.getScenario().fail("Added quantity failed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromBase64String(Extentlogger.getBase64Screenshot(driver)).build());
			log.onTestFailure("Fail");
